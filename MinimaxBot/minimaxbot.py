class MinimaxBot:
    ...
    def get_move(self, pos, tleft):
        ...
        for move in lmoves:
            curr_val = minimax(self, move, pos, 1, 3, True)
    ...
    def minimax(self, move, pos, depth, max_depth, my_turn):
        ...
        if my_turn:
            ...
            for l in lmoves:
                # set value to
                val = minimax(self, l, pos_copy, depth+1, max_depth, False)
                if not started:
                    best_val = val
                else:
            ...
            for l in lmoves:
                # set value to
                val = minimax(self, l, pos_copy, depth+1, max_depth, True)
                if not started:
                    best_val = val
                else:
